...
#define KBASE_IOCTL_MEM_UMM_EXPORT \
	_IOWR(KBASE_IOCTL_TYPE, 39, struct kbase_ioctl_mem_umm_export)
#endif
 ...
 * MTK_DTV ioctls *
 ******************/
/* FIXME: the UMM export ioctl should be defined in this section*/
...
#define KBASE_IOCTL_MFDEC_BIND_VIDEO_BUFFER \
	_IOWR(KBASE_IOCTL_EXTRA_TYPE, 1, struct kbase_ioctl_mfdec_info)

#define KBASE_IOCTL_MFDEC_UNBIND_VIDEO_BUFFER \
	_IOWR(KBASE_IOCTL_EXTRA_TYPE, 2, struct kbase_ioctl_mfdec_info)
#endif
