...
static const asf_guid_t asf_guid_sub_format_wma3 =
{0x162, 0x00, 0x10, {0x80, 0x00, 0x00, 0xAA, 0x00, 0x38, 0x9b, 0x71}};
...
guid_type_t ASFParser::asf_guid_get_sub_format_type(const asf_guid_t *guid)
{
    guid_type_t ret = GUID_UNKNOWN;

    if (asf_guid_match(guid, &asf_guid_sub_format_wma3)) {
        ret = GUID_DATAFORMAT_SUB_TYPE_WMA3;
    }
