...
#include "../../../sboot/inc/M7632/board/Board.h"
...
#define CONFIG_OF_LIBUFDT   1
#define CONFIG_DTB_ADDR 0x23000000       // dtb address for kernel
#define CONFIG_DTBO_ADDR 0x21600000      // dtbo address for temp used
#define CONFIG_RESERVE_DTB_SIZE 0x800000 // reserve 8MB for dtb
#define CONFIG_RAMDISK_ADDR 0x24000000
//# # # # # # # # # # # MIU Setting# # # # # # # # # # #
...
// If the chip has FSTR function, skip the frc and runtime PM flow even it only enable normal STR
#define CONFIG_SYS_SKIP_FAST_STR 1

//#############PM###################
#define CONFIG_PM_SIZE 0x9FFF
...
#define CONFIG_SYS_PROMPT           "<< M7632 >># "
...
// num of LXs, ex. LX1, LX2, LX3
#define CONFIG_NR_DRAM_NODES	3
...
#define CONFIG_MSPI_CS_DEMURA 1
