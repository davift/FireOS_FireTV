...
AES_NULL_KEY=$(SECUREDIR)/AESnull.bin
...
AES_TLAESKEY=$(SECUREDIR)/TLKey/$(CHIP_FOLDER)/AES_TLENC.bin
AES_TLKEY=$(SECUREDIR)/TLKey/$(CHIP_FOLDER)/AES_TL.bin
endif
ifeq ($(CONFIG_AUTH_BY_TLRSAKEY), y)
RSA_TLRSAKEY=$(SECUREDIR)/TLKey/$(CHIP_FOLDER)/RSA_TLPUB.bin
endif
ifeq ($(CONFIG_TEE_LOADER_HWAES_TEST), y)
TLAESKEYINPUT=$(SECUREDIR)/AES_TestInput.bin
endif
...
AVB_ORANGE_JPG_SRC = ../MstarCustomer/$(CUSTOMER)/sboot/bin/avb/orange_state.jpg
AVB_RED_JPG_SRC = ../MstarCustomer/$(CUSTOMER)/sboot/bin/avb/red_state.jpg
endif
