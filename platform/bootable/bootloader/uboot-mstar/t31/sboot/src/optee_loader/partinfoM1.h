...
#define BUILD_RESCUE_BOOT  0   // 1:rescue boot, 0:normal boot
...
#define PART_VALID_FLG_INVALID		0
#define PART_VALID_FLG_VALID		1
#define PART_VALID_FLG_UNKNOWN		2
#define UPDATE_PARTITION_MAX		(PARTITION_MAX/8)
...
};//structure size is 12368 bytes

extern struct partmap_info			partinfo;


#define DEFAULT_SBOOT___BASE		(CONFIG_EMMC_BASE)
#define DEFAULT_SBOOT___SIZE		(0x200000)

#define DEFAULT_BOOT__1_BASE		(DEFAULT_SBOOT___BASE + DEFAULT_SBOOT___SIZE)
#define DEFAULT_BOOT__1_SIZE		(0x300000)
...
#define DEFAULT_SWUE__1_SIZE		(0x2000000)
...
#define DEFAULT_PTT_SBOOT			{														\
	name		: "secureboot",																	\
	offset		: SWAP32(DEFAULT_SBOOT___BASE),	size		: SWAP32(DEFAULT_SBOOT___SIZE),\
...
#define DEFAULT_NUM_OF_PARTITION				8
#endif
...
extern int 							get_offset_size(int argc, char* argv[], unsigned long long* offset, unsigned long long* size);
extern int 							check_updated_partition(const char* part_name);
extern int 							set_valid_flag(char* update_list[]);
extern int 							swap_backup_partition(char* update_list[]);
extern int 							make_updated_part_list(char* update_list[]);
