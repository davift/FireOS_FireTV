...
#define _DRV_SEAL_H_
  ...
  #include "hal/M3822/halSEAL.h"
#elif defined(CONFIG_MSTAR_M5321)
  #include "hal/M5321/halSEAL.h"
#elif defined(CONFIG_MSTAR_M7632)
  #include "hal/M7632/halSEAL.h"
#elif defined(CONFIG_MSTAR_M7332)
  #include "hal/M7332/halSEAL.h"
#elif defined(CONFIG_MSTAR_M7642)
  #include "hal/M7642/halSEAL.h"
#else
...
typedef enum
{
    ...
    E_SEAL_MHEG5_AEON_D_PROT_NONPM             =1310,
    E_SEAL_MHEG5_AEON_I_PROT_NONPM             =1311,
    E_SEAL_VD_R2_BBU_PROTECTED_PROT_NONPM      =1312,
    E_SEAL_DISP_MFDEC0_PROT_NONPM              =1313,
    E_SEAL_DISP_MFDEC1_PROT_NONPM              =1314,
    E_SEAL_PATGEN_SC_ME_PROT_NONPM             =1315,
    E_SEAL_X32_RNG_DRBG_NONPM                  =1316,
    E_SEAL_X32_CHIPDBG_NONPM                   =1317,
    E_SEAL_MIU_SEC_LOG0_PROT_NONPM             =1318,
    E_SEAL_MIU_SEC_TEST_MODE_PROT_NONPM        =1319,
    E_SEAL_RIU_HUB_REG_PROT_NONPM              =1320,
    E_SEAL_RIU_PRE_HUB_REG_PROT_NONPM          =1321,
    E_SEAL_MIU_ARB_G_PROT_NONPM                =1322,
    E_SEAL_MIU_ARB_H_PROT_NONPM                =1323,
    E_SEAL_CACHE_TM0_PROT_NONPM                =1324,
    E_SEAL_RIU_PRE_HUB_PROT_NONPM              =1325,
    E_SEAL_AMB_PROT_NONPM                      =1326,
    E_SEAL_ZNR_PROT_NONPM                      =1327,
    E_SEAL_MI2OPME_F4_0_PROT_NONPM             =1328,
    E_SEAL_ZNR_PROTECTED_PROT_NONPM            =1329,
    E_SEAL_PM51_D_PROTECTED_PROT_NONPM         =1330,
    E_SEAL_PM51_I_PROTECTED_PROT_NONPM         =1331,
    E_SEAL_AU_AEC_PROT_NONPM                   =1332,
    E_SEAL_AU_ESW_PFLAG_A_PROTECTED_PROT_NONPM =1333,
    E_SEAL_AU_ESW_PFLAG_B_PROTECTED_PROT_NONPM =1334,
    E_SEAL_AU_ESW_PFLAG_C_PROTECTED_PROT_NONPM =1335,
    E_SEAL_AU_ESW_PFLAG_D_PROTECTED_PROT_NONPM =1336,
    E_SEAL_HSEW_PROT_NONPM                     =1337,
    E_SEAL_HSEW_PROTECTED_PROT_NONPM           =1338,
    E_SEAL_LCE_PROT_NONPM                      =1339,
    E_SEAL_MCDI_PROT_NONPM                     =1340,
    E_SEAL_MCDI_PROTECTED_PROT_NONPM           =1341,
    E_SEAL_MI2HVDM0_R_PROTECTED_PROT_NONPM     =1342,
    E_SEAL_MI2HVDM0_W_PROTECTED_PROT_NONPM     =1343,
    E_SEAL_MI2HVDM2_W_PROT_NONPM               =1344,
    E_SEAL_MI2HVDM2_W_PROTECTED_PROT_NONPM     =1345,
    E_SEAL_MI2IPM0_PROTECTED_PROT_NONPM        =1346,
    E_SEAL_MI2OPM0_PROTECTED_PROT_NONPM        =1347,
    E_SEAL_MI2OPME0_PROTECTED_PROT_NONPM       =1348,
    E_SEAL_MI2OPME_F4_0_PROTECTED_PROT_NONPM   =1349,
    E_SEAL_MI2OPMI0_PROTECTED_PROT_NONPM       =1350,
    E_SEAL_AU_MHDMA_PROT_NONPM                 =1351,
    E_SEAL_MGWIN_PROT_NONPM                    =1352,
    E_SEAL_MGWIN_PROTECTED_PROT_NONPM          =1353,
    E_SEAL_MHE_PROT_NONPM                      =1354,
    E_SEAL_MHE_PROTECTED_PROT_NONPM            =1355,
    E_SEAL_STR_PROT_NONPM                      =1356,
    E_SEAL_TSP_FILEIN1_PROTECTED_PROT_NONPM    =1357,
    E_SEAL_TSP_PVR_MULTI0_PVR1_PROTECTED_PROT_NONPM =1358,
    E_SEAL_TSP_PVR_MULTI0_PVR2_PROTECTED_PROT_NONPM =1359,
    E_SEAL_TSP_PVR_MULTI0_PVR3_PROTECTED_PROT_NONPM =1360,
    E_SEAL_TSP_PVR_MULTI0_PVR4_PROTECTED_PROT_NONPM =1361,
    E_SEAL_TSP_PVR_MULTI0_PVR5_PROTECTED_PROT_NONPM =1362,
    E_SEAL_TSP_PVR_MULTI0_PVR6_PROTECTED_PROT_NONPM =1363,
    E_SEAL_TSP_PVR_MULTI0_PVR7_PROTECTED_PROT_NONPM =1364,
    E_SEAL_TSP_PVR_MULTI0_PVR8_PROTECTED_PROT_NONPM =1365,
    E_SEAL_TSP_PVR_MULTI1_PVR1_PROTECTED_PROT_NONPM =1366,
    E_SEAL_TSP_PVR_MULTI1_PVR2_PROTECTED_PROT_NONPM =1367,
    E_SEAL_TSP_PVR_MULTI1_PVR3_PROTECTED_PROT_NONPM =1368,
    E_SEAL_TSP_PVR_MULTI1_PVR4_PROTECTED_PROT_NONPM =1369,
    E_SEAL_TSP_PVR_MULTI1_PVR5_PROTECTED_PROT_NONPM =1370,
    E_SEAL_TSP_PVR_MULTI1_PVR6_PROTECTED_PROT_NONPM =1371,
    E_SEAL_TSP_PVR_MULTI1_PVR7_PROTECTED_PROT_NONPM =1372,
    E_SEAL_TSP_PVR_MULTI1_PVR8_PROTECTED_PROT_NONPM =1373,
    E_SEAL_AIA_NORMAL_PROT_NONPM               =1374,
    E_SEAL_AIA_PROTECTED_PROT_NONPM            =1375,
	E_SEAL_IP_NUM                              =1376,
         E_SEAL_ALL_IP                              =32767,

    E_SEAL_MI2HVDM0_R_PROT_NONPM               = E_SEAL_HVDM0_R_PROT_NONPM,
    E_SEAL_MI2HVDM0_W_PROT_NONPM               = E_SEAL_HVDM0_W_PROT_NONPM,
    E_SEAL_MI2HR23_W_PROT_NONPM                = E_SEAL_MEHR_W_PROT_NONPM,
    E_SEAL_MI2HR23_R_PROT_NONPM                = E_SEAL_MIHR_R_PROT_NONPM,
    E_SEAL_DDI_PROT_NONPM                      = E_SEAL_DDI3_PROT_NONPM,
    E_SEAL_MI2LG_W_PROT_NONPM                  = E_SEAL_LG_W_PROT_NONPM,
    E_SEAL_MI2LG_R_PROT_NONPM                  = E_SEAL_LG_R_PROT_NONPM,
    E_SEAL_DDI_PROTECTED_PROT_NONPM            = E_SEAL_DDI3_PROTECTED_PROT_NONPM,
    E_SEAL_HSER_PROT_NONPM                     = E_SEAL_HSE_PROT_NONPM,
    E_SEAL_HSER_PROTECTED_PROT_NONPM           = E_SEAL_HSE_PROTECTED_PROT_NONPM,
}eSeal_IP;
...
typedef enum
{
    ...
    E_SEAL_MIU_REG_DIG_WR_PROTN                =316,
    E_SEAL_MIU_REG_TLB_WR_PROTN                =317,
    E_SEAL_MIU_PROT_WR_PROTN                   =318,
    E_SEAL_MIU_REG_CPU_WR_PROTN                =319,
    E_SEAL_MIU_DRAM_CONFIG_WR_PROTN            =320,
    E_SEAL_MIU_ARBITER_WR_PROTN                =321,
    E_SEAL_MIU_BIST_WR_PROTN                   =322,
    E_SEAL_MIU_BIST_RD_PROTN                   =323,
    E_SEAL_MIU_OTHER_DTOP_WR_PROTN             =324,
    E_SEAL_MIU_OTHER_ATOP_WR_PROTN             =325,
    E_SEAL_MIU_PROT_SEC_R2_WR_PROTN            =326,
    E_SEAL_PM_RST_WR_PROTN                     =327,
    E_SEAL_PM_POWER_WR_PROTN                   =328,
    E_SEAL_PM_CHIP_CONFIG_WR_PROTN             =329,
    E_SEAL_PM_PAD_MUX_WR_PROTN                 =330,
    E_SEAL_PM_CLK_CONFIG_PROTN                 =331,
    E_SEAL_PM_IOSC_PROTN                       =332,
    E_SEAL_PM_PAD_CTRL_WR_PROTN                =333,
    E_SEAL_PM_RST0_WR_PROTN                    =334,
    E_SEAL_PM_RST1_WR_PROTN                    =335,
    E_SEAL_PM_RST2_WR_PROTN                    =336,
    E_SEAL_PM_RST3_WR_PROTN                    =337,
    E_SEAL_PM_RST4_WR_PROTN                    =338,
    E_SEAL_PM_WHOLE_CHIP_RST_WR_PROTN          =339,
    E_SEAL_DSCRMB_WP_CTRL                      =340,
    E_SEAL_UPLL_PROTN_3                        =341,
    E_SEAL_UPLL_1_PROTN_3                      =342,
    E_SEAL_PWM_DAC_PAD_SEL_WR_PROTN            =343,
    E_SEAL_LOCK_NUM                            =344,
...
int MDrv_SEAL_DisableRIUBridges(void) __attribute__((section(".ldr.teepostloader.text")));
#else
